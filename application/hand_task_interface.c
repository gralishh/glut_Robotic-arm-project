 ...
 * @param hand_init 
 */
void Hand_Init(Hand_Control_t *hand_init)
{
  /*****PID赋值与初始化*****/
 ...
 * @param gimbal_init
 */
void hand_position_Init(Hand_Control_t *gimbal_init)
{
...
//      //Weird code,i dont remenber when i write like this. :(
//			SERVO2_RS485_Send((uint8_t *)(void *)&hand_GoM8010_init1,sizeof(hand_GoM8010_init1.motor_send_data));
//
//			vTaskDelay(15);
//			wait_time++;
//			if(wait_time > 100)
 ...
 */
void Hand_Set_Mode(Hand_Control_t *hand_motor_get)
{
 ...
 * @note 会修改设定角度
 */
void Hand_Set_Contorl( Hand_Control_t *hand_set_control)
{
 ...
 *  同时包含修改角度值的操作
 */
void HAND_relative_angle_limit(Hand_Motor_t *hand_Motor_t,fp32 add,fp32 max_limit,fp32 min_limit)
{
 ...
 */
void HAND_Mode_Change_Control_Transit(Hand_Control_t *hand_mode_change)
{
 ...
 * @note 会修改电机角度设定值
 */
void	Hand_Set_Position(Hand_Control_t *hand_set_position)
{
 ...
 */
void hand_motor_speed_control(Hand_Motor_t *hand_motor,fp32 SPEED_RATE)
{
    if (hand_motor == NULL)
    {
        return;
...
/// @brief RM电机停止
/// @param hand_motor 
void hand_motor_raw_angle_control(Hand_Motor_t *hand_motor)
{
    if (hand_motor == NULL)
    {
        return;
...
/// @brief GM电机停止
/// @param motor_send 
void hand_motor_GM_raw_angle_control(MOTOR_send *motor_send)
{
...
/// @param hand_motor 
/// @param SPEED_RATE 
void hand_motor_relative_angle_control(Hand_Motor_t *hand_motor,fp32 SPEED_RATE)
{
     if (hand_motor == NULL)
    {
        return;
...
/// @param hand_motor 
/// @param SPEED_RATE 
void hand_motor_lock_angle_angle_control(Hand_Motor_t *hand_motor,fp32 SPEED_RATE)
{
	     if (hand_motor == NULL)
    {
        return;
...
fp32 hand_motor_hollow_encoder_to_circle_angle(Hand_Motor_t hand_motor_measure , fp32 relative_angle_mid , uint8_t reduction_ratio)
{
	int attempt = 3;	
 ...
 * @return 
 */
void hand_motor_circle_measure(Hand_Motor_t *hand_motor)
{
...
/// @brief 用于调试控温
/// @param  
void Hand_Temperature_control(Hand_Control_t *hand_control)
{
...
float calculateResult(float inputNumber, float k, float b) {
