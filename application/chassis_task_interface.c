...
void chassis_task_init()
{
  ...
  DJI_Motor_Speed_PID_init(&DJI_Motor_LeftFront,PID_POSITION,20,0,0.001,5000,0);
  DJI_Motor_Pos_PID_init(&DJI_Motor_LeftFront,PID_POSITION,15,0,0,500,0);
  ...
  DJI_Motor_Speed_PID_init(&DJI_Motor_RightFront,PID_POSITION,20,0,0.001,5000,0);
  DJI_Motor_Pos_PID_init(&DJI_Motor_RightFront,PID_POSITION,15,0,0,500,0);
  ...
  DJI_Motor_Speed_PID_init(&DJI_Motor_LeftBack,PID_POSITION,20,0,0.001,5000,0);
  DJI_Motor_Pos_PID_init(&DJI_Motor_LeftBack,PID_POSITION,15,0,0,500,0);
  ...
  DJI_Motor_Speed_PID_init(&DJI_Motor_RightBack,PID_POSITION,20,0,0.001,5000,0);
  DJI_Motor_Pos_PID_init(&DJI_Motor_RightBack,PID_POSITION,15,0,0,500,0);
