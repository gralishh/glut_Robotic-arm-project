...
static void gimbal_Feedback_Update(Gimbal_Control_t *gimbal_feedback_update);//云台数据反馈
...
static void gimbal_Control_loop(Gimbal_Control_t *gimbal_control_loop);//云台控制PID计算
